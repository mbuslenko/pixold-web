      ...
      <section className="careers-page-vacancies">
        <div className="careers-page-open">
          ...
          <p className="careers-page-open-desc">
            We are looking for people like us with «burning eyes» to join our team. So if you would like to work at
            Pixold but don't see a suitable position on the list, please contact us at hello@pixold.io
          </p>
        </div>
